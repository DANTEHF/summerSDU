...
$(document).ready(function() {
    ...
    $(".x1 p").click(function() {
        ...
        $(".xmguanli_nr").attr("style", "display:none;"); //加
    ...
    $(".y1 p,.y1 img").click(function() {
        if ($(".y1 ul").is(":hidden")) {
            var val = 1;
            $(".y1 ul").slideDown("");
            $(".ul_y1 li").css("background-color", "#d10f0f");
    ...
    $(".y2 p,.y2 img").click(function() {
        if ($(".y2 ul").is(":hidden")) {
            var val = 1;
            $(".y2 ul").slideDown("");
            $(".ul_y2 li").css("background-color", "#d10f0f");
    ...
    $(".fanhui").click(function() {
        ...
        $(".xmguanli").attr("style", "display:block;");
        $(".fenye").attr("style", "display:block;");//加
        $(".yujing").attr("style", "display:none;");
        $(".rizhi").attr("style", "display:none;");
    });
    //返回按钮
    ...
    */
    ...
    //加 改位置    shitu2改为down-2  改左右视图的名称  待解决
    $(".down-2 ul li,.xmguanli button").click(function() {
    ...
    //判断复选框是否被选中
    $('.xialab').prop('disabled', true);
    $('.xialab').selectpicker('refresh');
    $(".xialab").on("click",function () {
        var self = $(this);
        if($("input[type='checkbox']").is(':checked')){
            self.parents("tr").find(".xialab").prop('disabled', false);
            self.parents("tr").find(".xialab").selectpicker('refresh');
